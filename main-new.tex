...
\begin{proof}
  ...
  rank-deficient. As a consequence, $\bm y$ is in $\X$. This proves
  the first assertion.
...
full rank $m$. Since in a neighbourhood of $(\xb,\thetab)$, $V$
...
previous references, as these previous works analyze the probability
...
we will not directly analyze the constructions used in that reference,
...
Subsection~\ref{ssec:algo} relied on an assertion that has since
