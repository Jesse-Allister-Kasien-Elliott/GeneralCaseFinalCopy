...
$V \cap \mathbb{R}^n$. Our main algorithm solves a square system. We model polar varieties as projections of Lagrangian systems so that we can maintain square systems. The modeling introduces additional genericity assumptions which we incorporate into our analysis.   
