...
$V \cap \mathbb{R}^n$. To obtain sharper degree estimates, rather than using a determinantal modeling of polar varieties, we model polar varieties as projections of Lagrangian systems. This modeling introduces additional genericity assumptions which we incorporate into our analysis.   
...
%%   intersect $\C((\A_{k,m})_{1 \le k,m \le n})[X_1,\dots,X_{i-1}]$
