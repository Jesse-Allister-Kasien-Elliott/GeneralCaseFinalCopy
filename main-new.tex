...
We analyze the bit complexity of an efficient
  ...
  Let $F=(f_1,\hdots, f_p)$ in $\mathbb{Q}[X_1, \hdots , X_n]^p$ be a sequence of polynomials with $V = V(F) \subset \C^n$ a smooth and equidimensional variety and $\langle F \rangle \subset  \C[X_1, \hdots , X_n]$ a radical ideal. Then, computing suitable sections of the
