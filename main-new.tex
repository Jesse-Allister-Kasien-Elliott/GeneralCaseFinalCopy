...
algebraic set. This work is a continuation of our analysis or
...
sequence of polynomials with $V = V(F) \subset \C^n$ smooth and
...
results, bounding the degree of the hypersurfaces we have to avoid.
...
genericity properties, but once this is done, we can rely on algorithm
...
Section~\ref{sec:overview} introduces polar varieties and discuess the
