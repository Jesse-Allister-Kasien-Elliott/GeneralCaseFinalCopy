...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Critical points and polar varieties} 
Let $V=V(F)$ be a $d$-equidimensional algebraic set, with $F = (f_1,\hdots,f_p)$ a sequence of polynomials in  $\C[X_1,\hdots,X_n]$. 
{\em Polar varieties} are higher dimensional critical loci introduced by $\td$ and play a central role to the algorithm, which computes suitable sections of the
