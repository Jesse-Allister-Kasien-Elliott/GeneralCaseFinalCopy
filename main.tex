...
\subsubsection{Characterizing the critical points}
    ...
    \end{align*}
    \noindent 
    Furthermore, we have to remove points where $\xb \not\in \sO;$ we thus define 
    \[
    \frak{Z}^{''} := \overline{\frak{Z}^{'}-\sO^{c}}.
    \]
    \begin{lemma}  
    ...
    \begin{proof}
      ...
      \frak{Z}\}, 
      \]
      and thus $(\xb,\thetab,\bm \ell) \in\frak{Z}'$. Since $\xb \in \sO$, we also have $(\xb,\thetab,\bm \ell) \in\frak{Z}{''}$. This proves the inclusion
      $Z \subset \mu(\frak{Z}{''})$.
      ...
      zero. As a result, $(\xb,\thetab)$ is in $Z$, which implies that $\xb \in \sO$ and $\mu(Y^o)$ is
